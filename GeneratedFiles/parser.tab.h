...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    IF = 258,                      /* IF  */
    ELSE = 259,                    /* ELSE  */
    OPERATOR0 = 260,               /* OPERATOR0  */
    OPERATOR1 = 261,               /* OPERATOR1  */
    OPERATOR2 = 262,               /* OPERATOR2  */
    OPERATOR3 = 263,               /* OPERATOR3  */
    UNIOPERATOR0 = 264,            /* UNIOPERATOR0  */
    UNIOPERATOR1 = 265,            /* UNIOPERATOR1  */
    DOT = 266,                     /* DOT  */
